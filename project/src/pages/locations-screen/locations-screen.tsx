...
function LocationsScreen({placesCount,offers}:LocationsScreenProps): JSX.Element {
        ...
        <div className="cities__places-container container">
          <section className="cities__places places">
            ...
            <div className="cities__places-list places__list tabs__content">
              {offers.map((offer,idOffer )=>{
                const keyValueOffer = `${idOffer}-${offer}`;
                return (
                  <article key={keyValueOffer} className="cities__card place-card" onMouseOver={()=>{setActiveOfferCard(`/offer/${keyValueOffer}`);}}>
